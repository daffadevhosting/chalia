...
var cart_kosong = '<div class="empty-cart" style="display: flex;flex-wrap: wrap;flex-direction: column;align-items: center;"><i class="fa fa-shopping-basket" aria-hidden="true" style="font-size: 95px;text-shadow: 0px 3px 10px #00000061;"></i><p class="center" style="text-shadow:4px 3px 3px #00000061;color:#fff">Keranjang Belanja Kosong</p></div><div class="cartUcihaItachi"></div>';
        ...
        generateSimpleCart = function (space) {
            ...
            cartColumnViews = {
                ...
                currency: function (item, column) {
                    return ["<span class='sub-total'>Total</span> " + simpleCart.toCurrency(item.get(column.attr) || 0)];
                },
                ...
                qty: function (item, column) {
                    return ["<span class='qty'>Jumlah </span> " + item.get(column.attr)];
                },
                ukuran: function (item, column) {
                    return ["<span class='size'>Berat</span> " + item.get(column.attr)];
                },
            ...
            simpleCart.extend({
                ...
                writeCart: function (selector) {
                    var TABLE = settings.cartStyle.toLowerCase(),
                        ...
                        x,
                        xlen;
                       $(".ck-btn,.basket-detail,.harga-total,#total-harga,.right_side,.lisQdaffadev,.chatWhatsapp,.cart-sidebar-footer").hide();
                ...
                createCartRow: function (item, y, TR, TD, container) {
                    ...
                    $(".ck-btn,.basket-detail,.harga-total,#total-harga,.right_side,.lisQdaffadev,.cart-sidebar-footer").show();
